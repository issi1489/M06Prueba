# Generated by Django 3.1.4 on 2021-01-28 01:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nombre', models.CharField(default=None, max_length=45, validators=[django.core.validators.MinLengthValidator(10, 'El nombre debe tener minimo 10 caracteres'), django.core.validators.MaxLengthValidator(45, 'El nombre puede tener hasta 45 caracteres')])),
                ...
                ('rol', models.CharField(choices=[('admin', 'admin'), ('medico', 'medico'), ('paciente', 'paciente'), ('cuidador', 'cuidador'), ('familiar', 'familiar')], default='admin', max_length=15)),
